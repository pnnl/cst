...
class TestMetadataDBApi(unittest.TestCase):
    ...
    local_default_uri = 'mongodb://gage.pnl.gov:27017'
    fileDictionary = dict()
  ...
  },
  {
    ...
    def setUp(self):
        self.local_default_uri = 'mongodb://gage.pnl.gov:27017'
        self.metadb = MetaDB(uri=self.local_default_uri)
        pass
    ...
    def test_03_remove_collection(self):
        ...
        name_out = self.metadb.add_collection(name=collection_name)
        named_file_dict = {'psc3': {'bus': {'bus_num': [1, 2, 3, 4, 5]}, 'branch': {'from_bus': [1, 1, 1, 3, 4], 'to_bus': [2, 3, 5, 2, 5]}, 'gen': {'bus_num': [1, 2, 3], 'id': ['1', '1', '1'], 'mw': [10, 20, 30]}, 'load': {'bus_num': [4, 5, 5], 'id': ['1', '1', '2'], 'mw': [12, 17, 25]}}}
    ...
    def test_04_add_dict(self):
        ...
        name_out = self.metadb.add_collection(name=collection_name)
        named_file_dict = {'psc4': {'bus': {'bus_num': [1, 2, 3, 4, 5]}, 'branch': {'from_bus': [1, 1, 1, 3, 4], 'to_bus': [2, 3, 5, 2, 5]}, 'gen': {'bus_num': [1, 2, 3], 'id': ['1', '1', '1'], 'mw': [10, 20, 30]}, 'load': {'bus_num': [4, 5, 5], 'id': ['1', '1', '2'], 'mw': [12, 17, 25]}}}
        obj_id = self.metadb.add_dict(collection_name, dict_name, named_file_dict)
    ...
    def test_05_get_dict_key_names(self):
        ...
        name_out = self.metadb.add_collection(name=collection_name)
        named_file_dict = {'psc5': {'bus': {'bus_num': [1, 2, 3, 4, 5]}, 'branch': {'from_bus': [1, 1, 1, 3, 4], 'to_bus': [2, 3, 5, 2, 5]}, 'gen': {'bus_num': [1, 2, 3], 'id': ['1', '1', '1'], 'mw': [10, 20, 30]}, 'load': {'bus_num': [4, 5, 5], 'id': ['1', '1', '2'], 'mw': [12, 17, 25]}}}
        obj_id = self.metadb.add_dict(collection_name, dict_name, named_file_dict)
    ...
    def test_06_check_unique_doc_name(self):
        ...
        name_out = self.metadb.add_collection(name=collection_name)
        named_file_dict = {'psc6': {'bus': {'bus_num': [1, 2, 3, 4, 5]}, 'branch': {'from_bus': [1, 1, 1, 3, 4], 'to_bus': [2, 3, 5, 2, 5]}, 'gen': {'bus_num': [1, 2, 3], 'id': ['1', '1', '1'], 'mw': [10, 20, 30]}, 'load': {'bus_num': [4, 5, 5], 'id': ['1', '1', '2'], 'mw': [12, 17, 25]}}}
        obj_id = self.metadb.add_dict(collection_name, dict_name, named_file_dict)
        file_name_unique = self.metadb._check_unique_doc_name(collection_name, dict_name)
    ...
    def test_08_get_collection_document_names(self):
        ...
        named_file_dict = {'psc8': {'bus': {'bus_num': [1, 2, 3, 4, 5]}, 'branch': {'from_bus': [1, 1, 1, 3, 4], 'to_bus': [2, 3, 5, 2, 5]}, 'gen': {'bus_num': [1, 2, 3], 'id': ['1', '1', '1'], 'mw': [10, 20, 30]}, 'load': {'bus_num': [4, 5, 5], 'id': ['1', '1', '2'], 'mw': [12, 17, 25]}}}
        obj_id = self.metadb.add_dict(collection_name, dict_name, named_file_dict)
    ...
    def test_09_remove_document(self):
        ...
        name_out = self.metadb.add_collection(name=collection_name)
        named_file_dict = {'psc9': {'bus': {'bus_num': [1, 2, 3, 4, 5]}, 'branch': {'from_bus': [1, 1, 1, 3, 4], 'to_bus': [2, 3, 5, 2, 5]}, 'gen': {'bus_num': [1, 2, 3], 'id': ['1', '1', '1'], 'mw': [10, 20, 30]}, 'load': {'bus_num': [4, 5, 5], 'id': ['1', '1', '2'], 'mw': [12, 17, 25]}}}
        obj_id = self.metadb.add_dict(collection_name, dict_name, named_file_dict)
        try:
            doc_names = self.metadb.get_collection_document_names(collection_name)
    ...
    def test_10_get_dict(self):
        ...
        name_out = self.metadb.add_collection(name=collection_name)
        named_file_dict = {'psc10': {'bus': {'bus_num': [1, 2, 3, 4, 5]}, 'branch': {'from_bus': [1, 1, 1, 3, 4], 'to_bus': [2, 3, 5, 2, 5]}, 'gen': {'bus_num': [1, 2, 3], 'id': ['1', '1', '1'], 'mw': [10, 20, 30]}, 'load': {'bus_num': [4, 5, 5], 'id': ['1', '1', '2'], 'mw': [12, 17, 25]}}}
        obj_id = self.metadb.add_dict(collection_name, dict_name, named_file_dict)
        ...
        self.assertEqual(dict_obj['psc10']['branch'],{'from_bus': [1, 1, 1, 3, 4], 'to_bus': [2, 3, 5, 2, 5]}, "[psc10]['branch'] elements do not match")
    ...
    def test_11_update_dict(self):
        ...
        test_result = self.metadb.update_dict(collection_name=collection_name, updated_dict=dict_obj, dict_name=dict_name)
