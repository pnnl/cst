...
import cosim_toolbox.dataLogger as cla
import unittest
...
class TestLoggerApi(unittest.TestCase):
    ...
    def test_get_query_string(self):
        test_db = cla.DataLogger()
        qry_string = test_db.get_query_string(500, 1000, "test_MyTest", "FederateLogger", "Battery/current3",
                                              "hdt_boolean")
        self.assertEqual(qry_string,
                         "SELECT * FROM test_myschema2.hdt_boolean WHERE time>=500 AND time<=1500 AND scenario='test_MyTest' AND federate='FederateLogger' AND data_name='Battery/current3'")
        qry_string2 = test_db.get_query_string(None, 1000, "test_MyTest", "FederateLogger", "Battery/current3",
                                               "hdt_boolean")
        self.assertEqual(qry_string2,
                         "SELECT * FROM test_myschema2.hdt_boolean WHERE time<=1000 AND scenario='test_MyTest' AND federate='FederateLogger' AND data_name='Battery/current3'")
        qry_string3 = test_db.get_query_string(500, None, "test_MyTest", "FederateLogger", "Battery/current3",
                                               "hdt_boolean")
        self.assertEqual(qry_string3,
                         "SELECT * FROM test_myschema2.hdt_boolean WHERE time>=500 AND scenario='test_MyTest' AND federate='FederateLogger' AND data_name='Battery/current3'")
        qry_string4 = test_db.get_query_string(500, 1000, None, "FederateLogger", "Battery/current3", "hdt_boolean")
        self.assertEqual(qry_string4,
                         "SELECT * FROM test_myschema2.hdt_boolean WHERE time>=500 AND time<=1500 AND federate='FederateLogger' AND data_name='Battery/current3'")
        qry_string5 = test_db.get_query_string(500, 1000, "test_MyTest", None, "Battery/current3", "hdt_boolean")
        self.assertEqual(qry_string5,
                         "SELECT * FROM test_myschema2.hdt_boolean WHERE time>=500 AND time<=1500 AND scenario='test_MyTest' AND data_name='Battery/current3'")
        qry_string6 = test_db.get_query_string(500, 1000, "test_MyTest", "FederateLogger", None, "hdt_boolean")
        self.assertEqual(qry_string6,
                         "SELECT * FROM test_myschema2.hdt_boolean WHERE time>=500 AND time<=1500 AND scenario='test_MyTest' AND federate='FederateLogger'")
        qry_string7 = test_db.get_query_string(None, None, None, None, None, "hdt_boolean")
    ...
    def test_query_scenario_all_times(self):
        test_db = cla.DataLogger()
        test_db.open_database_connections()
        df = test_db.query_scenario_all_times("test_MyTest", "hdt_boolean")
        test_db.close_database_connections()
        self.assertTrue(len(df) > 0)
