...
from cosim_toolbox import cosim_mongo_host, cosim_mongo_db, cu_scenarios
...
class TestFederate(unittest.TestCase):
    ...
    def test_connect_to_metadataDB(self):
        ...
        self.mock_DBConfig.get_dict.assert_called_with(cu_scenarios, None, self.federate.scenario_name)
    ...
    def test_create_federate(self):
        ...
        self.federate.connect_to_metadataDB.assert_called_with(cosim_mongo_host, cosim_mongo_db)
