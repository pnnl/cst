...
class ReadConfig:
    def __init__(self, scenario_name: str):
        ...
        meta_db = DBConfigs(cst.cosim_mg_host, cst.cosim_mongo_db)
        # retrieve data from MongoDB
        self.scenario = meta_db.get_dict(cst.cu_scenarios, None, scenario_name)
        ...
        if self.federation_name is not None:
            self.federation = meta_db.get_dict(cst.cu_federations, None, self.federation_name)
        # meta_db = None
