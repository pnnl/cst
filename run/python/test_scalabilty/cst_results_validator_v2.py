...
def validate_scenarios(cu_scalability: str):
    ...
    for scenario_dir_path in cu_scalability.iterdir():
        ...
        for out_csv in csv_dir_path.iterdir():
            ...
            df = pd.read_csv(out_csv, names=["real_time", "sim_time", "scenario", "federate", "data_name", "data_value"])
            ...
            df_ept_db = dr.get_results(federate_name=f"{federate}/pt_0", data_type=ValueType.ENDPOINT)
